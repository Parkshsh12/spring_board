			...
			<div class="inner">
					...
					<table width="100%" class="table02">
						...
						<tbody id="tbody">
							<tr>
								...
								<td><input type="text" id="boardSubject"
									name="boardSubject" class="tbox01"
									value="${map.BOARD_SUBJECT }" /></td>
							</tr>
							<tr>
								<th>작성자</th>
								<td>${map.BOARD_WRITER }
							...
							<tr>
								...
								<td colspan="3"><textarea id="boardContent"
										name="boardContent" cols="50" rows="5" class="textarea01">${map.BOARD_CONTENT }</textarea>
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div class="btn_right mt15">
					...
					<button type="button" class="btn black mr5"
						onclick="javascript:updateBoard();">저장</button>
